...
def main():
    ...
    if dataset == 75:
        ...
        # sys_edl_file = data_dir + 'LDC2015E75/data/all-mentions-tac-linked-type.txt'
        false_pos_file = data_dir + 'LDC2015E75/result/fp.txt'
        false_neg_file = data_dir + 'LDC2015E75/result/fn.txt'
    else:
        ...
        sys_edl_file = data_dir + 'LDC2015E103/data/all-mentions-tac.txt'
        # sys_edl_file = data_dir + 'LDC2015E103/data/all-mentions-tac-linked-type.txt'
        false_pos_file = data_dir + 'LDC2015E103/result/fp.txt'
        false_neg_file = data_dir + 'LDC2015E103/result/fn.txt'
