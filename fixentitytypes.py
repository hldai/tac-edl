...
def __fix_entity_types_by_mid():
    ...
    if dataset == 75:
        ...
        tac_edl_file = 'e:/el/LDC2015E103/data/all-mentions-tac-linked.txt'
        mid_type_file = 'e:/el/res/freebase/mid-entity-type.txt'
        dst_file = 'e:/el/LDC2015E103/data/all-mentions-tac-linked-type.txt'
    ...
    for m in mentions:
        ...
        # print m.mid
        fout.write('%s\t%s_%07d\t%s\t%s:%d-%d\t%s\t%s\t%s\n' % (
