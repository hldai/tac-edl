...
def main():
    ...
    if dataset == 75:
        ...
        name_dict_mentions_file = 'e:/el/LDC2015E75/data/name-dict-mentions.txt'
        post_author_file = 'e:/el/LDC2015E75/data/post-authors.txt'
        extra_mentions_file = 'e:/el/LDC2015E75/data/ner-expanded.txt'
        all_mentions_tac_edl_file = 'e:/el/LDC2015E75/data/all-mentions-tac.txt'
    else:
        ner_mentions_file = 'e:/el/LDC2015E103/data/ner-mentions.txt'
        name_dict_mentions_file = 'e:/el/LDC2015E103/data/name-dict-mentions.txt'
        post_author_file = 'e:/el/LDC2015E103/data/post-authors.txt'
        extra_mentions_file = 'e:/el/LDC2015E103/data/ner-expanded.txt'
        all_mentions_tac_edl_file = 'e:/el/LDC2015E103/data/all-mentions-tac.txt'
    ...
    __merge_mentions([ner_mentions_file, post_author_file, name_dict_mentions_file,
